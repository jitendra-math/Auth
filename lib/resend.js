...
<table width="100%" cellpadding="0" cellspacing="0" style="max-width:720px;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 25px 70px rgba(0,0,0,0.12);">

<!-- top luxury bar -->
<tr>
<td style="background:#0b0b0c;padding:14px 30px;text-align:center;">
<span style="color:#fff;font-size:12px;letter-spacing:2px;">JSS ORIGINALS • DIGITAL SYSTEMS</span>
</td>
</tr>
...
<img src="${logoUrl}" width="60" style="border-radius:14px;">
</div>

<!-- heading -->
<div style="text-align:center;font-size:36px;font-weight:700;color:#111;margin-bottom:25px;">
Official Website Proposal
</div>

<!-- society card -->
<div style="text-align:center;margin-bottom:35px;">
<div style="display:inline-block;background:#f6f7fb;border:1px solid #e6e7ec;border-radius:14px;padding:20px 28px;">
...
<!-- signature -->
<div style="margin-top:45px;padding-top:25px;border-top:1px solid #eee;">
<div style="font-size:18px;font-weight:700;color:#111;">Jitendra Singh</div>
<div style="font-size:14px;color:#6b7280;margin-top:6px;">Founder — JSS Originals</div>
<div style="font-size:14px;color:#6b7280;">Web & Digital Systems</div>
<div style="font-size:14px;color:#6b7280;">Nimod, Rajasthan</div>
<div style="font-size:14px;color:#6b7280;">jitendra@jssoriginals.online</div>
</div>
